# Agario AI
This is a Python implementation of a genetic algorithm to train recurrent neural networks, simple reflex agent, and a model-based reflex agent to play [agar.io](https://en.wikipedia.org/wiki/Agar.io).
